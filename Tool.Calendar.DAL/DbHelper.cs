...
namespace Tool.Calendar.DAL
{
    ...
    public class DbHelper
    {
        ...
        private static readonly string ConnectionString = Configuration.GetConnectionString("MySqlConnection");
        ...
        {
            return ExecuteScalar(Configuration.GetConnectionString("MySqlConnection"), cmdType, cmdText, commandParameters);
        }
        ...
        {
            return ExecuteNonQuery(Configuration.GetConnectionString("MySqlConnection"), cmdType, cmdText, commandParameters);
        }
        ...
        public static int DynamicUpdate(Hashtable ht, string tableName, string whereFiledName, int whereFiledValue, int whereFiledType)
        {
            ...
            try
            {
                int result = DbHelper.ExecuteNonQuery(safeSql, parameters);
                return result;
            }
            catch (Exception ex)
            {
        ...
        public static int DynamicInsert(Hashtable ht, string tableName)
        {
            ...
            try
            {
                int result = DbHelper.ExecuteScalar(CommandType.Text, safeSql, parameters);
                return result;
            }
            catch (Exception ex)
            {
